...
class CustomHeaderRenderer extends javax.swing.table.DefaultTableCellRenderer {
    ...
    private void initComponents() {
        ...
        jPanel4.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(1410, 500, 400, 60));
        ...
        jPanel4.add(jButton7, new org.netbeans.lib.awtextra.AbsoluteConstraints(1410, 420, 400, 60));
        ...
        jPanel4.add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(990, 500, 400, 60));
        ...
        jPanel4.add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(990, 420, 400, 60));
        ...
        jPanel4.add(jButton8, new org.netbeans.lib.awtextra.AbsoluteConstraints(1240, 620, 330, 60));
    ...
    // Tampilkan pesan
    JOptionPane.showMessageDialog(this, "Menampilkan nilai untuk NIS: " + nis);
    ...
    if (choice == 0) {
        showJasperReport("src/view/report2.jasper", nis, "Laporan Nilai");
    } else if (choice == 1) {
        showJasperReport("src/view/raport3.jasper", nis, "Laporan Rapor");
    }
}
...
private void showJasperReport(String reportPath, String nis, String title) {
    Connection conn = null;
    try {
