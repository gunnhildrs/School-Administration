...
public class UbahRapor extends javax.swing.JFrame {
    ...
    public UbahRapor(String[] raporData) {
        try {
            ImageIcon appIcon = new ImageIcon(home.class.getResource("/photos/logo.png"));
            setIconImage(appIcon.getImage());
        } catch (Exception e) {
       ...
       // Initialize combo boxes
        ...
        jLabel4.setText("Ubah Data Rapor");
        jButton6.setText("Simpan Perubahan");
        
        if (raporData != null) {
            fillFormWithData(raporData);
        }
...
private void fillFormWithData(String[] raporData) {
        if (raporData == null || raporData.length < 9) return;
        
        try {
            // Fill the form fields
            jTextField2.setText(raporData[0]); // nama (read-only)
            jTextField4.setText(raporData[1]); // kelas
            jComboBox9.setSelectedItem(raporData[2]); // semester
            jTextField6.setText(raporData[3]); // tahun ajaran
            jTextField8.setText(raporData[4]); // sakit
            jTextField3.setText(raporData[5]); // izin
            jTextField1.setText(raporData[6]); // alfa
            jComboBox8.setSelectedItem(raporData[7]); // status naik
            jTextArea1.setText(raporData[8]); // catatan wali kelas
    ...
    private void initComponents() {
        ...
        jPanel4.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 550, -1, 30));
        ...
        jPanel4.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 630, -1, 30));
        ...
        jPanel4.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 760, -1, 30));
        ...
        jPanel4.add(jTextField6, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 630, 350, 40));
        ...
        jPanel4.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 760, 760, -1));
        ...
        jPanel4.add(jComboBox9, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 550, 150, 40));
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        // TODO add your handling code here:
        UbahRapor homeForm = new UbahRapor();
    ...
    try {
        ...
        if (jTextField4.getText().trim().isEmpty() ||  // kelas
            jComboBox9.getSelectedItem() == null ||     // semester
            jTextField6.getText().trim().isEmpty()      // tahun ajaran
        ) {
            JOptionPane.showMessageDialog(this, "Harap isi Kelas, Semester, dan Tahun Ajaran!");
            return;
        }
        ...
        String tahunAjaran = jTextField6.getText();
        int sakit = jTextField8.getText().isEmpty() ? 0 : Integer.parseInt(jTextField8.getText());
        int izin = jTextField3.getText().isEmpty() ? 0 : Integer.parseInt(jTextField3.getText());
        int alfa = jTextField1.getText().isEmpty() ? 0 : Integer.parseInt(jTextField1.getText());
        String statusNaik = (String) jComboBox8.getSelectedItem();
        String catatan = jTextArea1.getText();

        // Database connection
        Connection conn = getConnection();
        if (conn != null) {
            String query = "UPDATE rapor SET " +
                    "nama_kelas = ?, " +
                    "jumlah_sakit = ?, " +
                    "jumlah_izin = ?, " +
                    "jumlah_alpa = ?, " +
                    ...
                    "WHERE Nama = ? AND semester = ? AND tahun_ajaran = ?";
            ...
            pst.setInt(3, izin);
            pst.setInt(4, alfa);
            pst.setString(5, statusNaik);
            pst.setString(6, catatan);
            pst.setString(7, nama);
            pst.setString(8, semester);
            pst.setString(9, tahunAjaran);

            int result = pst.executeUpdate();

            if (result > 0) {
                JOptionPane.showMessageDialog(this, "Data rapor berhasil diperbarui!");
                // Return to previous form
                Rapor raporForm = new Rapor();
                raporForm.setVisible(true);
                this.dispose();
            } else {
                JOptionPane.showMessageDialog(this, "Gagal memperbarui data rapor!");
            }
        ...
        JOptionPane.showMessageDialog(this, "Format angka tidak valid untuk sakit/izin/alpa: " + e.getMessage());
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UbahRapor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
