...
private Connection getConnection() {
    ...
    private void initComponents() {
        ...
        jPanel4.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 730, -1, 30));
        ...
        jPanel4.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1040, 730, 420, 40));
        ...
        jPanel4.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 650, -1, 30));
        ...
        jPanel4.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 730, -1, 30));
        ...
        jPanel4.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 650, -1, 30));
        ...
        jPanel4.add(jTextField8, new org.netbeans.lib.awtextra.AbsoluteConstraints(1040, 650, 420, 40));
        ...
        jPanel4.add(jTextField5, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 650, 350, 40));
        ...
        jPanel4.add(jTextField6, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 730, 350, 40));
        ...
        jPanel4.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1040, 510, 420, -1));
 ...
 Rapor homeForm = new Rapor();
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        // Validasi field wajib
            ...
            jTextField1.getText().trim().isEmpty() ||  // tahun masuk
        ...
        if (conn != null) {
            String query = "INSERT INTO siswa (nama, NIS, JK, NISN, tempatLahir, " +
                    "tanggalLahir, agama, alamat, noTelp, tahunMasuk, status) " +
                    "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";

            PreparedStatement pst = conn.prepareStatement(query);
            pst.setString(1, jTextField2.getText()); // nama
            pst.setString(2, jTextField4.getText()); // NIS
            pst.setString(3, (String) jComboBox4.getSelectedItem()); // JK
            pst.setString(4, jTextField5.getText()); // NISN
            pst.setString(5, jTextField6.getText()); // tempat lahir
            pst.setString(6, tanggalLahir); // tanggal lahir
            pst.setString(7, (String) jComboBox8.getSelectedItem()); // agama
            pst.setString(8, jTextArea1.getText()); // alamat
            pst.setString(9, jTextField8.getText()); // no telp
            pst.setString(10, jTextField1.getText()); // tahun masuk
            pst.setString(11, "Aktif"); // status (default)
