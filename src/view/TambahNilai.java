...
public class TambahNilai extends javax.swing.JFrame {
    ...
    public TambahNilai(String[] nilaiData) {
        this();
    ...
    private void loadNisData() {
        try {
            Connection conn = getConnection();
            if (conn != null) {
                String query = "SELECT nis FROM rapor";
                Statement stmt = conn.createStatement();
                ResultSet rs = stmt.executeQuery(query);
                
                jComboBox11.removeAllItems();
                while (rs.next()) {
                    jComboBox11.addItem(rs.getString("nis"));
                }
    ...
    private void initComponents() {
        ...
        jPanel4.add(jComboBox8, new org.netbeans.lib.awtextra.AbsoluteConstraints(1020, 380, 350, 40));
        ...
        jComboBox11.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "1", "2" }));
        jComboBox11.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jComboBox11ActionPerformed(evt);
            }
        });
        jPanel4.add(jComboBox11, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 390, 350, 40));
...
home homeForm = new home();
    ...
    try {
        ...
        String nis = (String) jComboBox11.getSelectedItem();
        ...
        Connection conn = getConnection();
        if (conn != null) {
            // INSERT query sesuai struktur database
            String query = "INSERT INTO nilai (NIS, nama_pelajaran, id_kelas, semester, tahun_ajaran, nilai_akhir, kompre, created_at, updated_at) " +
            ...
            pst.setString(5, tahunAjaran);
            pst.setString(6, nilaiAkhir);
            pst.setString(7, kompre);
            ...
            if (result > 0) {
                ...
                JOptionPane.showMessageDialog(this, "Gagal menambahkan data nilai!");
            }
            pst.close();
            conn.close();
        }
    } catch (SQLException e) {
        // Handle duplicate entry atau constraint violation
        if (e.getMessage().contains("Duplicate entry")) {
            JOptionPane.showMessageDialog(this, "Data nilai untuk siswa ini sudah ada! Silakan gunakan fitur edit.");
        } else {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TambahNilai().setVisible(true);
            }
        });
    }
